        ...
        <ul class="navbar-nav mr-3">
          ...
          <li>
            <form class="form-inline mr-auto">
              ...
              <a class="btn bg-primary" href="{{route('home')}}">Về Trang Khách hàng</a>
            </form>
    ...
    <div class="main-sidebar sidebar-style-2">
      <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="dropdown">
            <a href="/crudproduct" ><span>Quản Lý Sản Phẩm</span></a>
           
          </li>
          <li class="dropdown">
            <a href="/category" ><span>Quản Lý Danh Mục</span></a>
            
          </li>
          <li class="dropdown">
            <a href="{{route('list_order')}}" ><span>Quản Lý đơn hàng</span></a>
          </li>
          <li >
            <a href="{{route('user')}}" ><span>Quản lý người dùng</span></a>
