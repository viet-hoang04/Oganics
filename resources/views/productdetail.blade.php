            ...
            <div class="sumary-product single-layout">
                <div class="media">
                    <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                        ...
                        <li><img src="{{asset('frontend/images/products/'.$prodt->Image)}}" alt="" width="500" height="500"></li>
                    ...
                    <ul class="biolife-carousel slider-nav" data-slick='{"arrows":false,"dots":false,"centerMode":false,"focusOnSelect":true,"slidesMargin":10,"slidesToShow":4,"slidesToScroll":1,"asNavFor":".slider-for"}'>
                       @foreach ($data_img as $img)
                        ...
                        <li><img src="{{asset('frontend/images/products/'.$img->Image)}}" alt="" width="88" height="88"></li>
                        @endforeach
                    </ul>
                </div>
                <div class="product-attribute">
                    <h3 class="title">{{$prodt->ProductName}}</h3>
                    <div class="rating">
                    ...
                    <p class="excerpt">{{$prodt->Description}}</p>
                    <div class="price">
                        <ins><span class="price-amount"><span class="currencySymbol">£</span>{{ number_format($prodt->Price, 0, '', '.') }}</span></ins>
                    </div>
                    ...
                    <div class="contain-product layout-default">
                        <div class="product-thumb">
                            <a href="/productdetail/{{$pro->ProductID}}" class="link-to-product">
                                <img src="{{asset('frontend/images/products/'.$pro->Image)}}" alt="dd" width="270" height="270" class="product-thumnail">
                            </a>
                        </div>
                        <div class="info">
