                            ...
                            @else
                                <li>
                                    <a href="{{ route('profile') }}" class="user-link">
                                        <i class="biolife-icon icon-user"></i>Chào, {{ Auth::user()->name }}
                                    </a>
                                    <ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="/" class="biolife-logo"><img src="{{asset('frontend/images/organic-3.png')}}" alt="biolife logo" width="135" height="34"></a>
                    </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        ...
                                                        <li class="menu-item"><a class="menu-name" href="/login">Login/Register</a></li>
                                                    ...
                                                    <ul class="posts">
                                                        <li>
                                                            <div class="block-post-item">
                                                                <div class="thumb">
                                                                    <a href="#"><img src="assets/images/megamenu/thumb-05.jpg" width="100" height="73" alt=""></a>
                                                                </div>
                                                                <div class="left-info">
                                                        ...
                                                        <li>
                                                            <div class="block-post-item">
                                                                <div class="thumb">
                                                                    <a href="#"><img src="assets/images/megamenu/thumb-06.jpg" width="100" height="73" alt=""></a>
                                                                </div>
                                                                <div class="left-info">
                                                                    <h4 class="post-name"><a href="#">Ashwagandha: The #1 Herb in the World for Anxiety?</a></h4>
                                                        ...
                                                        <li>
                                                            <div class="block-post-item">
                                                                <div class="thumb">
                                                                    <a href="#"><img src="assets/images/megamenu/thumb-07.jpg" width="100" height="73" alt=""></a>
                                                                </div>
                                                                <div class="left-info">
                                                                    <h4 class="post-name"><a href="#">Ashwagandha: The #1 Herb in the World for Anxiety?</a></h4>
                        ...
                        <div class="biolife-cart-info">
                            <div class="mobile-search">
                                ...
                                {{-- <div class="mobile-search-content">
                                    <form action="{{route('search')}}" class="form-search" name="mobile-seacrh" method="GET">
                                        <a href="#" class="btn-close"><span class="biolife-icon icon-close-menu"></span></a>
                                        <input type="text" name="query" class="input-text" value="" placeholder="tìm kiếm">
                                        
                                        <button type="submit" class="btn-submit">search</button>zdczds
                                    </form>
                                </div> --}}
                            </div>
                        ...
                        <div class="vertical-menu vertical-category-block">
                            ...
                            <div class="wrap-menu">
                                <ul class="menu clone-main-menu">
                                    ...
                                    <li class="menu-item"><a href="/shop_cate/{{$cat->CategoryID}}" class="menu-title"><i class="biolife-icon icon-fresh-juice"></i>{{$cat->CategoryName}}</a></li>
                                    @endforeach
